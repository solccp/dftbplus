...
contains
  ...
  #:endif
    ...
    call initArrays(env, electronicSolver, tForces, tExtChrg, isLinResp, tLinRespZVect, tMd,&
        ...
        & derivs, repDerivs, chrgForces, energy, potential, TS, E0, Eband, eigen, filling, coord0Fold,&
            ...
            if (input%ctrl%orbEneRead(jj, iSp)) then
              ...
              do kk = 0, 2 * ii
                write(*, "(A,T30,A2,2X,I1,'(',A1,'): ',E14.6)") trim(strTmp), speciesName(iSp), jj, &
                    & trim(orbitalNames(kk-ii,ii)), atomEigVal(jj, iSp)
              end do
            end if
          end do
        end do
...
#:endif
  ...
  subroutine initArrays(env, electronicSolver, tForces, tExtChrg, isLinResp, tLinRespZVect, tMd,&
      ...
      & repDerivs, chrgForces, energy, potential, TS, E0, Eband, eigen, filling, coord0Fold, newCoords,&
